      ...
      <section>
        <p>
          ...
          <dl>
            ...
            <br />
            <dd>
              <em>무색무취 : 아무런 빛깔과 냄새가 없음</em>
            </dd>
          </dl>
        </p>
        <p>
          사람으로 얘기하자면, 어디서든 무던하게, 그냥 있는 사람이었으면 좋겠다.
          <br />
        ...
        <p>
          개성이 없다는 말도, 아무튼 누군가를 개성있게 만들어 주는거라 생각하면
          또 마음이 편하다.
          <br />
        ...
        <p>
          눈에 잘 띄게 살아가는 것도 하나의 재능이고 무색무취로 살아가는 것도
          하나의 재능이라고 생각한다.
          <br />
          이상한건가 생각도 해봤는데 모두가 원하는 게 다른 것처럼 이게
          내가 원하는 거라는 걸 요즘은 조금 알 것 같다.
        </p>
        <p>
          쉽진 않겠지만 치우치지 않고, 균형잡힌 사람으로 살아보고싶다.
          <br />
        </p>
      </section>
    </article>
